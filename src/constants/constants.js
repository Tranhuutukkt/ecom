...
export const ADD_RETURN_SUCCESS = 'ADD_RETURN_SUCCESS';
export const GET_RETURN_BY_USER = 'GET_RETURN_BY_USER';
export const GET_RETURN_BY_USER_SUCCESS = 'GET_RETURN_BY_USER_SUCCESS';
export const GET_ALL_RETURN = 'GET_ALL_RETURN';
export const GET_ALL_RETURN_SUCCESS = 'GET_ALL_RETURN_SUCCESS';
export const CHANGE_RETURN_STATUS = 'CHANGE_RETURN_STATUS';
export const CHANGE_RETURN_STATUS_SUCCESS = 'CHANGE_RETURN_STATUS_SUCCESS';